...
__MEMPOOL_MIN_BLOCK_SIZE_UNITS__=${MEMPOOL_MIN_BLOCK_SIZE_UNITS:=32000000}
__MEMPOOL_INITIAL_BLOCKS_AMOUNT__=${MEMPOOL_INITIAL_BLOCKS_AMOUNT:=8}
__MEMPOOL_MEMPOOL_BLOCKS_AMOUNT__=${MEMPOOL_MEMPOOL_BLOCKS_AMOUNT:=1}
...
__MEMPOOL_USER_AGENT__=${MEMPOOL_USER_AGENT:=explorer}
...
__EXTERNAL_DATA_SERVER_MEMPOOL_API__=${EXTERNAL_DATA_SERVER_MEMPOOL_API:=https://bchexplorer.cash/api/v1}
__EXTERNAL_DATA_SERVER_MEMPOOL_ONION__=${EXTERNAL_DATA_SERVER_MEMPOOL_ONION:=http://someuniondomain.onion/api/v1}
...
# MEMPOOL_SERVICES
__MEMPOOL_SERVICES_API__=${MEMPOOL_SERVICES_API:="https://bchexplorer.cash/api/v1/services"}
...
sed -i "s!__MEMPOOL_MIN_BLOCK_SIZE_UNITS__!${__MEMPOOL_MIN_BLOCK_SIZE_UNITS__}!g" explorer-config.json
