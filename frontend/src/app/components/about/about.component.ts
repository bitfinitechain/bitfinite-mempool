...
export class AboutComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.seoService.setDescription(
      $localize`:@@meta.description.about:Learn more about the BitFinite Explorer open-source project. Discover enterprise sponsors, integrations, FOSS licensing, and more.`
    );
