        ...
        data.utxoInputs.length === 0
          ...
          : [
              ...
              },
              {
                ...
                type: 'line',
                yAxisIndex: 1,
                lineStyle: { width: 1, color: '#3b6ef5' },
                itemStyle: { color: '#3b6ef5' },
                areaStyle: { color: '#3b6ef5', opacity: 0.25 },
              },
              {
                name: $localize`UTXO Outputs`,
                showSymbol: false,
                ...
                type: 'line',
                yAxisIndex: 1,
                lineStyle: { width: 1, color: '#2456c8' },
                itemStyle: { color: '#2456c8' },
                areaStyle: { color: '#2456c8', opacity: 0.25 },
              },
            ],
      dataZoom: [
        {
