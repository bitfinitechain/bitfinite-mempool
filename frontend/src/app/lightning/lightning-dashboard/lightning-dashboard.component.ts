...
export class LightningDashboardComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription(
      $localize`:@@meta.description.lightning.dashboard:Get stats on the Lightning network (aggregate capacity, connectivity, etc), Lightning nodes (channels, liquidity, etc) and Lightning channels (status, fees, etc).`
    );
