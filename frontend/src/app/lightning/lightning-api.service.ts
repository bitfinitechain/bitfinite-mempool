...
export class LightningApiService {
  ...
  getChannelsByNodeId$(
    ...
    const params = new HttpParams()
      ...
      .set('status', status);
    return this.httpClient.get<any>(
      this.apiBaseUrl + this.apiBasePath + '/api/v1/lightning/channels',
  ...
  getLatestStatistics$(): Observable<any> {
    return this.httpClient.get<any>(
      this.apiBaseUrl + this.apiBasePath + '/api/v1/lightning/statistics/latest'
    );
  }
  ...
  getNodesRanking$(): Observable<INodesRanking> {
    return this.httpClient.get<INodesRanking>(
      this.apiBaseUrl + this.apiBasePath + '/api/v1/lightning/nodes/rankings'
    );
  }
